package com.yhk.mybatisplus2.core.utils;
...
public class FtpUtils {
    ...
    //ftp服务器地址
    public static String hostname = "192.168.18.238";
    //ftp服务器端口号默认为21
    public static Integer port = 21;
    //ftp登录账号
    public static String username = "root";
    //ftp登录密码
    public static String password = "4251..";
...
//            ftpClient.enterLocalPassiveMode();
    ...
    public static void main(String[] args) {
        ...
        uploadFile("/aa/a", "nginx-1.18.0.zip", "E:\\Download\\nginx-1.18.0.zip");
//        downloadFile("test/oea/bg9", "nginx-1.18.0.zip", "F://");
//        deleteFile("ftpFile/data", "nginx-1.18.0.zip");
        log.info("ok");
    }
}
